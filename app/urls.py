...
urlpatterns = [
    ...
    path('superadmin/transcript/<int:pk>/download/', views.superadmin_download_transcript, name='superadmin_download_transcript'),
    path('superadmin/transcript/<int:pk>/qr/', views.superadmin_transcript_qr, name='superadmin_transcript_qr'),
